  ...
  Widget _buildBtnAnimation(BuildContext context) {
    return CupertinoButton(
      child: Container(
          ...
          decoration: const BoxDecoration(borderRadius: BorderRadius.all(Radius.circular(10.0)), color: primary),
          child: Text(title!,
              textAlign: TextAlign.center, style: Theme.of(context).textTheme.titleMedium!.copyWith(color: white, fontWeight: FontWeight.normal))),
      onPressed: () {
        onBtnSelected!();
      },
    );
