...
class _MobileOTPState extends State<VerifyOtp> with TickerProviderStateMixin {
      ...
      _firebaseAuth.signInWithCredential(phoneAuthCredential).then((UserCredential value) {
        if (value.user != "") {
          ...
          if (widget.title == FORGOT_PASS_TITLE) {
            Navigator.pushReplacement(context, CupertinoPageRoute(builder: (context) => SetPass(mobileNumber: mobile!)));
          }
        } else {
  ...
  mobText() {
    return Padding(
      padding: const EdgeInsets.only(bottom: 10.0, left: 40.0, right: 40.0, top: 10.0),
      child: Align(
        alignment: Alignment.center,
        child: Text("+$countrycode-$mobile", style: Theme.of(context).textTheme.titleMedium!.copyWith(color: white, fontWeight: FontWeight.normal)),
      ),
    );
  }
      ...
      child: Row(
        ...
        children: [
          Text(
            ...
            style: Theme.of(context).textTheme.bodySmall!.copyWith(color: white, fontWeight: FontWeight.normal),
          ),
          InkWell(
              onTap: () async {
                await buttonController!.reverse();
              ...
              child: Text(
                ...
                style: Theme.of(context)
                    .textTheme
                    .bodySmall!
                    .copyWith(color: white, decoration: TextDecoration.underline, fontWeight: FontWeight.normal),
              ))
        ],
      ),
    );
